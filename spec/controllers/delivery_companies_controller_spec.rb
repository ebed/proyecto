...
RSpec.describe DeliveryCompaniesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all delivery_companies as @delivery_companies" do
      delivery_company = DeliveryCompany.create! valid_attributes
  ...
  describe "GET #show" do
    it "assigns the requested delivery_company as @delivery_company" do
      delivery_company = DeliveryCompany.create! valid_attributes
      get :show, params: {id: delivery_company.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested delivery_company as @delivery_company" do
      delivery_company = DeliveryCompany.create! valid_attributes
      get :edit, params: {id: delivery_company.to_param}, session: valid_session
      expect(assigns(:delivery_company)).to eq(delivery_company)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new DeliveryCompany" do
        expect {
          post :create, params: {delivery_company: valid_attributes}, session: valid_session
        }.to change(DeliveryCompany, :count).by(1)
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved delivery_company as @delivery_company" do
        post :create, params: {delivery_company: invalid_attributes}, session: valid_session
        expect(assigns(:delivery_company)).to be_a_new(DeliveryCompany)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested delivery_company" do
        delivery_company = DeliveryCompany.create! valid_attributes
        put :update, params: {id: delivery_company.to_param, delivery_company: new_attributes}, session: valid_session
      ...
      it "assigns the requested delivery_company as @delivery_company" do
        delivery_company = DeliveryCompany.create! valid_attributes
        put :update, params: {id: delivery_company.to_param, delivery_company: valid_attributes}, session: valid_session
        expect(assigns(:delivery_company)).to eq(delivery_company)
      end
    ...
    context "with invalid params" do
      it "assigns the delivery_company as @delivery_company" do
        delivery_company = DeliveryCompany.create! valid_attributes
        put :update, params: {id: delivery_company.to_param, delivery_company: invalid_attributes}, session: valid_session
        expect(assigns(:delivery_company)).to eq(delivery_company)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested delivery_company" do
      delivery_company = DeliveryCompany.create! valid_attributes
      expect {
        delete :destroy, params: {id: delivery_company.to_param}, session: valid_session
      }.to change(DeliveryCompany, :count).by(-1)
    end
